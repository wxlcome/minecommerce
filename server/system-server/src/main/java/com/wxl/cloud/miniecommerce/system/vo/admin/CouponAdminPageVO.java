...
/**
 * @ClassName  ：CouponAdminPageVO
 * @description：优惠券管理分页VO
 * @author     ：wxl
 * @date       ：2024/12/09 13:10
 */
@Data
@Schema(name="CouponAdminPageVO",description="优惠券管理分页VO")
public class CouponAdminPageVO implements Serializable {
