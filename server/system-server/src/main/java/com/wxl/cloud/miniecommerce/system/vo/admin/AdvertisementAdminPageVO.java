...
/**
 * @ClassName  ：AdvertisementAdminPageVO
 * @description：广告管理分页vo
 * @author     ：wxl
 * @date       ：2024/12/08 05:34
 */
@Data
@Schema(name="AdvertisementAdminVO",description="广告管理分页vo")
public class AdvertisementAdminPageVO implements Serializable {
